...
import com.legou.mapper.TbOrderItemMapper;
import com.legou.mapper.TbOrderMapper;
import com.legou.mapper.TbOrderShippingMapper;
...
public class OrderServiceImpl implements OrderService {
	...
	private String ORDER_ID_GEN_KEY;//ORDER_ID_GEN
	@Value("${ORDER_ID_START}")
	private String ORDER_ID_START;//100544
	@Value("${ORDER_DETAIL_ID_GEN_KEY}")
	private String ORDER_DETAIL_ID_GEN_KEY;//ORDER_DETAIL_ID_GEN
	
	@Override
	public LegouResult createOrder(OrderInfo orderInfo) {
